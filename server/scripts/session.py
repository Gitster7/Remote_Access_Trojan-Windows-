...
""") 
    ...
    def lonelyDestruction(self):
        ...
        printColor("information","\n[!] Are you sure you want to run the destruction mode on the client ? Once the destruction mode is launched the client removes all traces of IOTcybersec. This means that if you have several clients on the same machine they will all be deleted and therefore they will no longer be accessible.\nIf you are sure of your choice enter Y if not enter N.\n")
        if(areYouSure()):
